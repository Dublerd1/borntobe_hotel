                  ...
                  >
                    ...
                    <div className="overflow-hidden relative">
                      ...
                      <div className="absolute top-0 left-0 px-3 py-1.5" style={{ background: '#C8965A' }}>
                        <span className="text-[12px] font-bold text-white tracking-wide">${price.perNight}<span className="font-normal text-white/70 text-[10px] ml-0.5">{price.isMonthly ? '/mo' : '/n'}</span></span>
                      </div>
                    </div>
